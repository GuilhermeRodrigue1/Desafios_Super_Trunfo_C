...
int main(){
    ...
    printf("Carta 2:\nEstado: %c\nCodigo: %c%s\nNome da cidade: %s\nPopulacao: %i\nArea: %.2f Km\nPIB: %.2f Bilhoes de reais\nNumeros de ponto turisticos: %i\nDensidade Populacional: %.2lf hab/km\nPIB per Capita: %.2lf Reais\n\n", Estado2, Estado2, CodigoCarta2, NomeCidade2, PopulacaoEstado2, AreaCidade2, PIBCidade2, PontosTuristicosCidade2, DensidadePopulacao2, PIBperCapita2);
    ...
    short int resultadoDensidade = 2;
    short int resultadoSuperPoder = 2;

    printf("Comparacao de cartas:\nPopulacao cidade 1 maior que a 2? (%d)\nArea cidade 1 maior que a 2? (%d)\nPIB cidade 1 maior que a 2? (%d)\nPontos turisticos cidade 1 maior que a 2? (%d)\nDensidade populacional cidade 1 maior que a 2? (%d)\nPIB per capita cidade 1 maior que a 2? (%d)\nSuper Poder cidade 1 maior que a 2? (%d)\n", resultadoPopulacao, resultadoArea, resultadoPIB, resultadoPontosTuristicos, resultadoDensidade, resultadoPIBperCapita, resultadoSuperPoder);

    /*
     * Exibindo no terminal as informações coletadas atraves do "scanf()"
     */
